...
<!-- activity starts -->
 - [@addyess](https://github.com/addyess) has pushed the commit **Run configure hook only on leader** to [charm-kube-ovn](https://github.com/charmed-kubernetes/charm-kube-ovn)
